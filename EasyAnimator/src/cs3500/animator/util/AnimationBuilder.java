...
/**
 * Interface used for adapting the model interface that is expected by AnimationReader to the model
 * that we created, IAnimation.
 *
 * @param <Doc> model representation of an animation, IAnimation.
 */
